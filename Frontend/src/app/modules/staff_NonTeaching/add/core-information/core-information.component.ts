...
export class CoreInformationComponent implements OnInit, OnDestroy {
    ...
    // Lecturer/ Asst. Professor/ Associate Professor / Professor
    designations = ['Lecturer','Asst. Professor', 'Associate Professor','Professor'];
    faculties = [];
    allSchools = [];
    allDepartments = [];
    ...
    ngOnInit(): void {
        ...
        this.NameDetails = this._formBuilder.group({
            AtVu_FirstName: [''],
            AtVu_MiddleName: [''],
            AtVu_LastName: [''],
            Earlier_FirstName: [''],
        ...
        this.DesignationDetailsForm = this._formBuilder.group({
            joiningDesignation: [''],
            StartDate: [''],
            EndDate: [''],
            Designation_Role: [''],
            Designation_Role_Start_Date: [''],
            Designation_Role_End_Date: [''],
        });
        ...
        this.dSub = this.deptService.getDepartments().subscribe((data) => {
            ...
            this.filteredDepartments = this.CoreInformation.controls.section.valueChanges.pipe(
                startWith(''),
                map(value => this._filter(value))
            );
        })

        this.CoreInformation.controls.section.valueChanges.subscribe((value) => {
