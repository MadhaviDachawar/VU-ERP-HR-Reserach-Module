...
export class CommunicationDetailsComponent implements OnInit {
    ...
    SpouseDetailsCols: string[] = ["Name", "Email", "Mobile", "Edit", "Delete"];
    ...
    ngOnInit(): void { this.SpouseDetailsDataSource = new MatTableDataSource([]); }
